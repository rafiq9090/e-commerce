...
async function main() {
  ...
  await prisma.siteContent.createMany({
    data: [
      ...
      { key: 'menu_text_color', value: '#111827', type: 'TEXT' },
      { key: 'menu_hover_color', value: '#2563eb', type: 'TEXT' },
      { key: 'menu_active_color', value: '#1d4ed8', type: 'TEXT' },
      { key: 'menu_bg_color', value: '#ffffff', type: 'TEXT' },
      { key: 'menu_hover_bg', value: '#eff6ff', type: 'TEXT' },
      { key: 'admin_sidebar_bg', value: '#111827', type: 'TEXT' },
      { key: 'admin_sidebar_text', value: '#d1d5db', type: 'TEXT' },
      { key: 'admin_sidebar_hover_bg', value: '#1f2937', type: 'TEXT' },
      { key: 'admin_sidebar_active_bg', value: '#111827', type: 'TEXT' },
      { key: 'admin_sidebar_active_text', value: '#ffffff', type: 'TEXT' },
      { key: 'admin_sidebar_badge_bg', value: '#ef4444', type: 'TEXT' },
      { key: 'admin_sidebar_badge_text', value: '#ffffff', type: 'TEXT' },
